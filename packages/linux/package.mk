...
case "$LINUX" in
  xdarklight)
    PKG_VERSION="a1a7bd9d49cbcf47dd90b0e935eb018e5ba74bc4" # Meson 8* 20200630
    PKG_SHA256=""
  ...
  *)
	...
	if [ "$UBOOT_SYSTEM" = "rk3328" -o "$UBOOT_SYSTEM" = "rk3328-old" ]; then
		PKG_PATCH_DIRS+=" 3328"
	fi
    fi
...
make_target() {
  ...
  kernel_make LOADADDR=$SRC_LOADADDR $KERNEL_TARGET $KERNEL_MAKE_EXTRACMD modules
